...
## Report bugs using Github's [issues](https://github.com/Cheeta-Panel/Cheeta-Panel/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/Cheeta-Panel/Cheeta-Panel/issues); it's that easy!
